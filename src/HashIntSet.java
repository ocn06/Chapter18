...
public class HashIntSet {
    ...
    //Ex 1, p. 1118
    public void addAll(HashIntSet h) {
        for (HashEntry e : h.elementData) {
            if (e != null) {
                add(e.data);
            }
        }
    ...
    //Ex3
    public boolean equals(HashIntSet h) {
        for (HashEntry e : h.elementData) {
            if (e != null) {
                if (!equals(e.data)) {
                    return false;
    ...
    //Ex4
    public void removeAll(HashIntSet h) {
        for (HashEntry e : h.elementData) {
            if (e != null) {
                if (contains(e.data)) {
                    remove(e.data);
    ...
    //Ex5
    public void retainAll(HashIntSet h) {
        for (HashEntry e : h.elementData) {
            if (e != null) {
                if (!contains(e.data)) {
                    remove(h.hashFunction(hashCode()));
                }
            }
        }
    }
    ...
    //Ex6
    public int[] toArray () {
        int[] array = new int[elementData.length];
